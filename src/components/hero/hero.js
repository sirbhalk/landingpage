                ...
                <div className="row g-4 align-items-center">
                    <div className="col-lg-6">
                        <div className="hero-content">
                            ...
                            <button onClick={() => navigationHelpers.goToConfigurator()} className="theme-btn theme-btn-2 wow fadeInUp" data-wow-delay="1.1s" style={{ marginLeft: '15px' }}>Try 3D Configurator</button>
                        </div>
                    </div>
